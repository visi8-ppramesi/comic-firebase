<template>
  <div class="text-white pa-5">
    <h1>Privacy Policy for Visi8</h1>
    <p>
      At Kara: Guardian of Realms, accessible from
      https://comics-77200.web.app/, one of our main priorities is the privacy
      of our visitors. This Privacy Policy document contains types of
      information that is collected and recorded by Kara: Guardian of Realms and
      how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Kara: Guardian of Realms. This policy is not applicable
    ...
    <p>
      Kara: Guardian of Realms follows a standard procedure of using log files.
    ...
    <p>
      Like any other website, Kara: Guardian of Realms uses 'cookies'. These
    ...
    <P
      ...
      advertising partners of Kara: Guardian of Realms.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Kara: Guardian of Realms, which
    ...
    <p>
      Note that Kara: Guardian of Realms has no access to or control over these
    ...
    <p>
      Kara: Guardian of Realms's Privacy Policy does not apply to other
    ...
    <p>
      Kara: Guardian of Realms does not knowingly collect any Personal
