<template>
    ...
    <Transition name="overlay">
        <div v-show="showSelf" style="transition: opacity 0.5s ease;" ref="videoContainer" class="absolute h-screen w-screen bg-black flex justify-center justify-items-center content-center items-center">
...
export default {
    ...
    data(){
        return {
            source: 'https://firebasestorage.googleapis.com/v0/b/comics-77200.appspot.com/o/comics%2FSSb0da8HXyie7DbcAEve%2Fchapter_2%2Fextras%2Fvideo_chapter_2_5.mp4?alt=media',
            showSelf: false
        }
    },
    methods: {
