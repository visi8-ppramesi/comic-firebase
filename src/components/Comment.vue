                ...
                <div class="flex flex-col w-full">
                    <div class="flex flex-row">
                        <div class="px-3 flex flex-col flex-grow items-start justify-center gap-y-1">
                            <span class="font-extrabold text-sm leading-3 lg:text-md xl:text-lg">{{ userName }}</span> <span class="=lg:text-sm xl:text-md text-xs text-gray-900 leading-3">{{ formattedDate }}</span>
                        </div>
                    ...
                    <div class="pl-3 sm:pl-3 text-left pt-3 lg:text-md xl:text-lg">
                        {{ commentMessage }}
                    </div>
                </div>
            </div>
